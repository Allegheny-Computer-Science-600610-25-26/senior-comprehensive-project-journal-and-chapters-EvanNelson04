...
resource constraints, and user-facing goals of a mobile fitness application. Rather than implementing computationally expensive or
externally dependent analytical frameworks, the system relies on lightweight, in-memory Swift operations — specifically filtering,
sorting, and aggregation over a structured array of workout entries. This section justifies why these methods were chosen, how they
support the application's core purpose, and why they are well-suited to the mobile context in which the app operates.
